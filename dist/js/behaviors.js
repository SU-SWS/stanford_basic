  ...
  attach: function attach(context, settings) {
    (function ($) {
      ...
      if ($search) {
        ...
        $($ms.clone()).prependTo('.su-masthead .su-multi-menu > ul', context).wrap('<li class="su-mobile-site-search"></li>').attr('id', 'block-stanford-basic-search-mobile').find('[id]').each(function () {
          $(_this).attr('id', $(_this).attr('id') + '-mobile');
        });
